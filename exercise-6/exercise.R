...
# Wrong code as we don't need to put data frames
#husky.games.2015 <- data.frame(read.csv("huskies_2015.csv"), stringsAsFactors = FALSE)
...
index <- max(combined.yards)
husky.games.2015[index]
